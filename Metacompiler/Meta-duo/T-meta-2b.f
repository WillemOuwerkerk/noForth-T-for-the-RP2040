...
: PFXOBJECT,    ( pfx# <ccc> -- data-xt doval ) \ test op DOVAL
    ...
    over <> ?abort              \ LISA is not a value
...
vocs? if
    s" noforth tv duo 2.bin"
    cr 2dup type  r/o bin open-file \ Add second image file
else
    s" noforth t duo 2.bin"
    CR 2dup type  r/o bin open-file \ Add second image file
then
    abort" Duo 2 file failed " >r
    r@ file-size throw d>s to bin#
